...
public class HitboxRectangleImplBug extends HitboxImpl implements HitboxRectangleService{
	private int	height;
	private int	width;

	public HitboxRectangleImplBug(int x, int y, int height, int width) {
		super(x,y);
